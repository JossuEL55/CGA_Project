...
<div class="container mx-auto p-4 max-w-lg">
  <h1 class="text-2xl font-bold mb-4">Crear Técnico</h1>
  ...
  <form action="{{ route('tecnicos.store') }}" method="POST" novalidate>
    @csrf
    ...
    <input type="text" id="cedula" name="cedula" value="{{ old('cedula') }}" placeholder="Cédula única" class="border p-2 rounded w-full mb-4" required>

    <label class="block mb-1 font-semibold" for="especialidad">Especialidad *</label>
    <input type="text" id="especialidad" name="especialidad" value="{{ old('especialidad') }}" placeholder="Especialidad" class="border p-2 rounded w-full mb-4" required>
